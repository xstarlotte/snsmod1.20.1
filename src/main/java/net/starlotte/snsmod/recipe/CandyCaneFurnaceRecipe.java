...
public class CandyCaneFurnaceRecipe extends AbstractCookingRecipe {
    public CandyCaneFurnaceRecipe(ResourceLocation pId, String pGroup,
    ...
    public ItemStack getToastSymbol() {
        return new ItemStack(SNSBlocks.CANDY_CANE_FURNACE.get());
    }
    ...
    public static class Type implements RecipeType<CandyCaneFurnaceRecipe> {
        public static final Type INSTANCE = new Type();
    }

    public static class Serializer implements RecipeSerializer<CandyCaneFurnaceRecipe> {
        private final int defaultCookingTime;
        public static final CandyCaneFurnaceRecipe.Serializer INSTANCE = new Serializer(50);

        public Serializer(int defaultCookingTime) {
            this.defaultCookingTime = defaultCookingTime;
        }

        public CandyCaneFurnaceRecipe fromJson(ResourceLocation pRecipeId, JsonObject pJson) {
            ...
            return new CandyCaneFurnaceRecipe(pRecipeId, s, cookingbookcategory, ingredient, itemstack, f, i);
        }

        public CandyCaneFurnaceRecipe fromNetwork(ResourceLocation pRecipeId, FriendlyByteBuf pBuffer) {
        ...
        public void toNetwork(FriendlyByteBuf pBuffer, CandyCaneFurnaceRecipe pRecipe) {
