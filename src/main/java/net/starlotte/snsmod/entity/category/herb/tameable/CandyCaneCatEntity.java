...
public class CandyCaneCatEntity extends TamableAnimal implements GeoEntity {
    ...
    private <T extends GeoAnimatable> PlayState predicate(AnimationState<T> tAnimationState) {
        if(tAnimationState.isMoving()) {
            tAnimationState.getController().setAnimation(RawAnimation.begin().then("animation.cat.running", Animation.LoopType.LOOP));
            return PlayState.CONTINUE;
        }
        if(this.isSitting()) {
            tAnimationState.getController().setAnimation(RawAnimation.begin().then("animation.cat.sitting", Animation.LoopType.LOOP));
            return PlayState.CONTINUE;
        }
...
//AI
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverLevel, AgeableMob mob) {
        return SNSEntities.CANDY_CANE_CAT.get().create(serverLevel);
    }
    @Override
