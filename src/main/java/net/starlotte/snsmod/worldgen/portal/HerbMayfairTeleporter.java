package net.starlotte.snsmod.worldgen.portal;
...
import net.starlotte.snsmod.block.custom.HerbMayfairPortalBlock;
    ...
    public Entity placeEntity(Entity entity, ServerLevel currentWorld, ServerLevel destinationWorld,
        ...
        if (insideDimension) {
            ...
            for (BlockPos checkPos : BlockPos.betweenClosed(destinationPos.below(10).west(10),
                ...
                if (destinationWorld.getBlockState(checkPos).getBlock() instanceof HerbMayfairPortalBlock) {
                    doSetBlock = false;
                    break;
                }
            }
            ...
            if (doSetBlock) {
                destinationWorld.setBlock(destinationPos, SNSBlocks.HERB_MAYFAIR_PORTAL.get().defaultBlockState(), 3);
            }
        }
